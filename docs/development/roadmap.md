...
| Area                | State                                                                                                                                                                                                                                                  | Evidence                                                                                                                                                                 |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Supabase PostgreSQL | Real project in `.env` (`DATABASE_URL`, `DIRECT_URL`); **all 14 migrations applied** (including `conversation_pin`, `chat_image_jobs`, `user_interests` and `personal_instructions`, 2026-09-17)                                                       | `pnpm exec prisma migrate status` → "Database schema is up to date"                                                                                                      |
