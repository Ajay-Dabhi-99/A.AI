...
| Area                | State                                                                                                                                                                                                                                                  | Evidence                                                                                                                                                                 |
| ------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Supabase PostgreSQL | Real project in `.env` (`DATABASE_URL`, `DIRECT_URL`); **all 12 migrations applied** (including `conversation_pin` and `chat_image_jobs`, 2026-09-17)                                                                                                  | `pnpm exec prisma migrate status` → "Database schema is up to date"                                                                                                      |
