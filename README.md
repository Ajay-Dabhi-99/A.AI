...
- **Search:** find chats by what was said in them, with the matching text highlighted.
- **Share links:** publish a read-only snapshot of a chat that anyone with the link can open.
- **Message actions:** copy answers and code blocks, regenerate the latest answer, and edit your latest question.
- **Personal instructions:** tell A.ai about yourself and how it should respond; every chat follows them.
